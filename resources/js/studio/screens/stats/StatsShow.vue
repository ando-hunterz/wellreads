                                ...
                                <div class="d-flex py-2 align-items-center">
                                    <div class="mr-auto">
                                        <div v-if="host === trans.app.other">
                                            <p class="mb-0 py-1">
                                                <img :src="`https://favicons.githubusercontent.com/${host}`" :style="Studio.darkMode === true ? {filter: 'invert(100%)'} : ''" :alt="host" class="mr-1"/>
...
<script>
    ...
    export default {
        ...
        beforeRouteEnter(to, from, next) {
            next(vm => {
                vm.request()
                    .get(Studio.canvasPath+'/api/stats/' + vm.id)
                    .then(response => {

<template>
  <nav class="navbar py-2">
      ...
      <div class="align-items-center my-auto">
        ...
        <div v-else class="btn-group">
          <a
            ...
            class="action-muted-btn text-decoration-none ml-3"
            href="/login"
          >Sign in</a>
    ...
    <div
      class="d-flex justify-content-start col-xl-10 offset-xl-1 col-lg-10 offset-lg-1 col-md-12 px-0 mt-1"
      id="topic-sel"
    >
      <div v-if="this.$route.name == 'home'" class="btn-group px-auto">
        <router-link
          class="topic-btn text-decoration-none px-3 mx-3"
          :to="{ name: 'popular-posts' }"
        >Popular</router-link>
        <router-link

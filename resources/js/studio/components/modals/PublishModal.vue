            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <p class="text-secondary text-center text-lg-left">
                        {{ trans.app.post_scheduling_format }} <span class="font-weight-bold">{{ Studio.timezone }}</span> {{ trans.app.timezone }}. (m/d/y h:m)
                    </p>

                    <div class="row">
                        <div class="col-sm-6 col-12 pb-sm-0 pb-3 pr-sm-0 d-flex justify-content-center justify-content-sm-start">
                            <div class="d-flex align-items-center">
                                <select :class="!Studio.darkMode ? 'bg-light': 'bg-darker'" class="w-auto custom-select custom-select-sm border-0" v-model="components.month">
                                ...
                                <select :class="!Studio.darkMode ? 'bg-light': 'bg-darker'" class="w-auto custom-select custom-select-sm border-0" v-model="components.day">
                                ...
                                <span class="px-1">/</span>
                                <select :class="!Studio.darkMode ? 'bg-light': 'bg-darker'" class="w-auto custom-select custom-select-sm border-0" v-model="components.year">
                        ...
                        <div class="col-sm-6 col-12 pl-sm-0 d-flex justify-content-center justify-content-sm-start">
                            <div class="d-flex align-items-center">
                                <select :class="!Studio.darkMode ? 'bg-light': 'bg-darker'" class="w-auto custom-select custom-select-sm border-0" v-model="components.hour">
                                ...
                                <span class="px-1">:</span>
                                <select :class="!Studio.darkMode ? 'bg-light': 'bg-darker'" class="w-auto custom-select custom-select-sm border-0" v-model="components.minute">

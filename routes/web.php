...
Route::namespace('Studio')->group(function() {
    ...
    Route::prefix(config('studio.path'))->group(function () {
...
|--------------------------------------------------------------------------
|
| Here is the routes for Api Without Auth
|
*/
Route::prefix(config('canvas.path'))->group(function () {
    Route::prefix('api')->group(function () {
